...
| U-4   | U      | bot identifies itself at runtime without being told its open_id   |
| U-5   | U      | works in a group with 3+ bots all running the plugin              |
| U-6   | U      | plugin schema rejects any topology-bound config field             |
